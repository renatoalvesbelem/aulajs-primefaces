...
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	@Autowired
	private SimpleJdbcTemplateImp simpleJdbcTemplate;

	@Autowired
	private SimpleJdbcInsertImp simpleJdbcInsert;
	...
	public List<T> findList(Class<T> entidade) throws Exception {
		...
		query.append("select district(entity)").append(entidade.getSimpleName()).append(" entity");
		@SuppressWarnings("unchecked")
...
//roda instantaneamente a instrução no banco de dados
